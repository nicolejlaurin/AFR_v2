...
export default () => (
	...
	<p> Model - Zuleima Sargsyan </p>
		...
		<div class="campaign-split">
				<img class="campaign-img" src={Img1}></img>
				<img class="campaign-img" src={Img2}></img>
				<img class="campaign-img" src={Img3}></img>
				<img class="campaign-img" src={Img4}></img>
				<img class="campaign-img" src={Img5}></img>
				<img class="campaign-img" src={Img6}></img>
	</div>
	</div>
);
